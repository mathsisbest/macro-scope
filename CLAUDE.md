...
and serves it through a Streamlit dashboard. It's an end-to-end data platform
(GitHub `mathsisbest`) to build an end-to-end data platform:
...
- Owner is a developer — values clarity and good SWE hygiene.
