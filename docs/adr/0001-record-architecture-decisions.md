...
per decision, in the Nygard format (Context / Decision / Consequences).

**Consequences.** A small, durable trail of design intent that's easy to extend as the project
evolves.
