...
## 1. Why this project (the portfolio narrative)
...
That single sentence touches every skill you want to demonstrate.

| Skill area | Where it shows up | What it proves |
|---|---|---|
...
> If you ever want literal streaming on the CV, Phase 4 (§12) adds an optional Kafka-style
...
If you want it on the CV, add `src/mmi/ingestion/odds.py` against **The Odds API** free tier
...
4. Work the roadmap phase by phase — each phase is a clean set of PRs that tells your skill story.
